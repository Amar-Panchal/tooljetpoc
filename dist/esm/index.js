...
var AppWithProfiler = Sentry.withProfiler(App);
var language = "en";
var path = "/";
i18n
    .use(Backend)
    ...
    lng: language,
    backend: {
        loadPath: "".concat(path, "assets/translations/{{lng}}.json"),
    },
});
...
// }
// });
render(React.createElement(AppWithProfiler, null), document.getElementById("app"));
