...
export const VerificationSuccessInfoScreen =
  function VerificationSuccessInfoScreen() {
    ...
    const organizationId = new URLSearchParams(location?.state?.search).get(
      "oid"
    );
    const single_organization =
                      ...
                      {(configs?.google?.enabled || configs?.git?.enabled) &&
                        source !== "sso" && (
                          <div className="d-flex flex-column align-items-center separator-bottom">
                            ...
                            <div
                              className="separator-onboarding "
                              style={{ width: "100%" }}
                            >
                              <div
                        ...
                        >
                          {isLoading ? (
                            ...
                            <>
                              <span>
                                {t(
                                  "verificationSuccessPage.acceptInvite",
                                  "Accept invite"
                                )}
                              </span>
                ...
                <div className="info-screen-wrapper">
                  <div className="verification-success-card">
                    ...
                    <h1
                      ...
                      data-cy="onboarding-page-header"
                    >
                      {t(
                        "verificationSuccessPage.successfullyVerifiedEmail",
                        "Successfully verified email"
                      )}
                    </h1>
                    <p
                      className="info-screen-description"
                      data-cy="onboarding-page-description"
                    >
                    ...
                    >
                      {isLoading ? (
                        ...
                        <>
                          {t(
                            "verificationSuccessPage.setupTooljet",
                            "Set up ToolJet"
                          )}
