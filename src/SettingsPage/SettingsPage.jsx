              ...
              <div className="row align-items-center">
                <div className="col">
                  ...
                  <h2 className="page-title" data-cy="page-title">
                    {t(
                      "header.profileSettingPage.profileSettings",
                      "Profile Settings"
                    )}
                  </h2>
                </div>
            ...
            <div className="container-xl">
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="mb-3">
                        ...
                        >
                          {t(
                            "header.profileSettingPage.firstName",
                            "First name"
                          )}
                        </label>
                        <input
                          ...
                          name="first-name"
                          placeholder={t(
                            "header.profileSettingPage.enterFirstName",
                            "Enter first name"
                          )}
                          value={firstName}
                    ...
                    <div className="col">
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          name="last-name"
                          placeholder={t(
                            "header.profileSettingPage.enterLastName",
                            "Enter last name"
                          )}
                          value={lastName}
              ...
              <div className="card">
                <div className="card-header">
                  ...
                  >
                    {t(
                      "header.profileSettingPage.changePassword",
                      "Change password"
                    )}
                  </h3>
                </div>
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="mb-3">
                        ...
                        >
                          {t(
                            "header.profileSettingPage.currentPassword",
                            "Current password"
                          )}
                        </label>
                        <input
                          ...
                          name="last-name"
                          placeholder={t(
                            "header.profileSettingPage.enterCurrentPassword",
                    ...
                    <div className="col">
                      <div className="mb-3">
                        ...
                        >
                          {t(
                            "header.profileSettingPage.newPassword",
                            "New password"
                          )}
                        </label>
                        <input
                          ...
                          name="last-name"
                          placeholder={t(
                            "header.profileSettingPage.enterNewPassword",
                            "Enter new password"
                          )}
                          value={newPassword}
                          onChange={(event) =>
                  ...
                  <div className="w-50 confirm-input">
                    <div className="mb-3">
                      ...
                      >
                        {t(
                          "header.profileSettingPage.confirmNewPassword",
