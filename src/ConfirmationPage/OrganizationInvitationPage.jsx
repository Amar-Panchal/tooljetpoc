...
class OrganizationInvitationPageComponent extends React.Component {
  constructor(props) {
    ...
    this.organizationId = new URLSearchParams(
      props?.location?.state?.search
    ).get("oid");
    this.source = new URLSearchParams(props?.location?.state?.search).get(
      "source"
    );
  }
  ...
  acceptInvite = (e) => {
    ...
    const isSetPassword =
      !!this.state?.userDetails?.onboarding_details?.password;
                    ...
                    <form action="." method="get" autoComplete="off">
                      {isGettingConfigs ? (
                        ...
                        <div className="common-auth-container-wrapper">
                          ...
                          <div
                            className="invite-sub-header"
                            data-cy="workspace-invite-page-sub-header"
                          >
                            {`You are invited to ${
                              this.state?.configs?.name
                          ...
                          <p className="text-center-onboard d-block">
                            ...
                            <br />
                            <span>
                              <a href="https://www.tooljet.com/terms">
                                Terms of Service{" "}
                              </a>
                              &
                              <a href="https://www.tooljet.com/privacy">
                                {" "}
                                Privacy Policy
                              </a>
                            </span>
                      ...
                      <form action="." method="get" autoComplete="off">
                        {isGettingConfigs ? (
                          ...
                          <div className="common-auth-container-wrapper">
                                ...
                                <div className="d-flex flex-column">
                                  {this.state?.configs?.google?.enabled && (
                                    <div className="login-sso-wrapper">
                                      <GoogleSSOLoginButton
                                        text={this.props.t(
                                          "confirmationPage.signupWithGoogle",
                                          "Sign up with Google"
                                        )}
                                        configs={
                                          this.state?.configs?.google?.configs
                                        }
                                        configId={
                                          this.state?.configs?.google?.config_id
                                        }
                                      />
                                    </div>
                                  )}
                                  {this.state?.configs?.git?.enabled && (
                                    <div className="login-sso-wrapper">
                                      <GitSSOLoginButton
                                        text={this.props.t(
                                          "confirmationPage.signupWithGitHub",
                                          "Sign up with GitHub"
                                        )}
                                        configs={
                                          this.state?.configs?.git?.configs
                                        }
                                      />
                                    </div>
                                  )}
                            ...
                            <p
                              className="text-center-onboard d-block"
                              data-cy="signup-terms-helper"
                            >
                              By signing up you are agreeing to the
                              <br />
                              <span>
...
export const OrganizationInvitationPage = withTranslation()(
  OrganizationInvitationPageComponent
);
