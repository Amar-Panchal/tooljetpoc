    ...
    <div className="flex">
      <div className="onboarding-navbar onboarding-navbar-layout">
        ...
        <div className="onboarding-checkpoints">
          <p
            className={page == 0 ? `active-onboarding-tab` : ""}
            data-cy="set-up-admin-check-point"
          >
            <img
              src={
                darkMode
          ...
          <p
            className={
              page >= 2 ? `active-onboarding-tab` : `passive-onboarding-tab`
            }
        ...
        {page > 0 && (
          <div
            className="onboarding-account-name"
            data-cy="user-account-name-avatar"
          >
      ...
      <div className="page-wrap-onboarding">
        <div className="onboarding-form">
          <div
            className={
              page !== 0 ? "onboarding-progress" : "onboarding-progress-layout"
            }
          >
            <div className="navigation-wrap">
              ...
              <div className="onboarding-bubbles-container">
                {page > 1 && <OnboardingBubblesSH page={page} />}
              </div>
              {page > 1 && (
                <div
                  className="onboarding-back-button"
          ...
          <div className="form-container">
            <div className="onboarding-header-wrapper">
              <h1
                className="onboarding-page-header"
                data-cy="onboarding-page-header"
              >
                {FORM_TITLES[page]}
              </h1>
              <p
                className="onboarding-page-sub-header"
                data-cy="onboarding-page-sub-header"
              >
                {FormSubTitles[0]}
              </p>
            </div>
