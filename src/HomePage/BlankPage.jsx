                ...
                <div className="col-6">
                  ...
                  >
                    {t(
                      ...
                      "Welcome to your new ToolJet workspace"
                    )}
                  </h3>
                  <p
                    className={`empty-title ${darkMode && "text-white-50"}`}
                    data-cy="empty-homepage-description"
                  >
                    {t(
                  ...
                  <div className="row mt-4">
                    ...
                    <div className="col">
                      <a
                        className={`btn empty-import-button ${
                          isImportingApp ? "btn-loading" : ""
                        }`}
