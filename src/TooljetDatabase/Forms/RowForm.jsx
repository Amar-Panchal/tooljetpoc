...
const RowForm = ({ onCreate, onClose }) => {
  const { organizationId, selectedTable, columns } = useContext(
    ...
    switch (dataType) {
      ...
      case "double precision":
        return (
          <input
            defaultValue={
              !isPrimaryKey && defaultValue?.length > 0
                ...
                <div className="mb-3" key={index}>
                  ...
                  >
                    ...
                    <span
                      ...
                      data-cy={`${String(dataType)
                        .toLocaleLowerCase()
                        .replace(/\s+/g, "-")}-data-type-label`}
                    >
