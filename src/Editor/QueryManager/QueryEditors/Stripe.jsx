  ...
  render() {
    ...
    if (selectedOperation) {
      if (selectedOperation.parameters) {
        pathParams = selectedOperation.parameters.filter(
          (param) => param.in === "path"
        );
        queryParams = selectedOperation.parameters.filter(
    ...
    const currentValue =
      this.state.options?.operation + "," + this.props.options?.path ?? null;
      ...
      <div>
        {loadingSpec && (
          <div className="p-3">
            ...
            {this.props.t(
              "stripe",
              "Please wait while we load the OpenAPI specification for Stripe."
            )}
          </div>
        )}
        ...
        {options && !loadingSpec && (
          <div>
            <div className="row g-2">
              ...
              <div
                className="col stripe-operation-options"
            ...
            {selectedOperation && (
              <div
                className={`row stripe-fields-row ${
                  this.props.darkMode && "theme-dark"
                }`}
              >
                {pathParams.length > 0 && (
                  <div
                    className={`path-fields ${
                      Object.keys(requestBody.schema.properties).length === 0 &&
                      "d-none"
                    }`}
                  >
                          ...
                          <div className="input-group">
                            ...
                            <div className="col field overflow-hidden">
                              <CodeHinter
                                currentState={this.props.currentState}
                                initialValue={
                                  this.state.options.params?.query[
                                    param.name
                                  ] ?? ""
                                }
                                mode="text"
                            ...
                            <span
                              ...
                              role="button"
                              onClick={() =>
                                this.removeParam("query", param.name)
                              }
                            >
                              <svg
                                width="auto"
                ...
                {requestBody.schema.properties && (
                  ...
                  >
                    ...
                    <div
                      className={`${
                        Object.keys(requestBody.schema.properties).length >=
                          1 && "input-group-parent-container"
                      }`}
                    >
                      {Object.keys(requestBody.schema.properties).map(
                        (param) => (
                          <div className="input-group-wrapper" key={param.name}>
                            <div className="input-group">
                              <div className="col-auto field field-width-179">
                              ...
                              <span
                                ...
                                role="button"
                                onClick={() =>
                                  this.removeParam("request", param)
                                }
                              >
                                <svg
                                  width="auto"
