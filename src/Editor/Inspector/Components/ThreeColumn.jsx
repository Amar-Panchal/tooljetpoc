...
class ThreeColumnComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  onActionButtonPropertyChanged = (index, property, value) => {
    const actions =
      this.props.component.component.definition.properties.actions;
  ...
  actionButtonEventsChanged = (events, index) => {
    let actions =
      this.props.component.component.definition.properties.actions.value;
  ...
  columnEventChanged = (columnForWhichEventsAreChanged, events) => {
    const columns =
      this.props.component.component.definition.properties.columns.value;
  ...
  setColumnPopoverRootCloseBlocker(key, isBlocking) {
    if (isBlocking) {
      ...
      this.setState((prev) => ({
        popOverRootCloseBlockers: prev.popOverRootCloseBlockers.filter(
          (b) => b !== key
        ),
      }));
    }
  ...
  columnPopover = (column, index) => {
    ...
    return (
      <Popover
        id="popover-basic-2"
        className={`${
          this.props.darkMode && "popover-dark-themed theme-dark"
        } shadow`}
      >
        <Popover.Content>
          <div className="field mb-2" data-cy={`dropdown-column-type`}>
            ...
            <SelectSearch
              className={`${
                this.props.darkMode ? "select-search-dark" : "select-search"
              }`}
              options={[
          ...
          <div data-cy={`input-and-label-key`} className="field mb-2">
            <label className="form-label">
              {this.props.t("widget.Table.key", "key")}
            </label>
            <CodeHinter
              ...
              componentName={this.getPopoverFieldSource(
                column.columnType,
                "key"
              )}
          ...
          {(column.columnType === "string" ||
            ...
            <div>
              <div
                data-cy={`input-and-label-text-color`}
                className="field mb-2"
              >
                <label className="form-label">
                  {this.props.t("widget.Table.textColor", "Text color")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
                  ...
                  onChange={(value) =>
                    this.onColumnItemChange(index, "textColor", value)
                  }
                  componentName={this.getPopoverFieldSource(
                    column.columnType,
                    "textColor"
              ...
              <div
                className="field mb-2"
                data-cy={`input-and-label-cell-background-color`}
              >
                <label className="form-label">
                  {this.props.t(
                    "widget.Table.cellBgColor",
                ...
                <CodeHinter
                  ...
                  placeholder={""}
                  onChange={(value) =>
                    this.onColumnItemChange(index, "cellBackgroundColor", value)
                  }
                  componentName={this.getPopoverFieldSource(
                    column.columnType,
                    "cellBackgroundColor"
                  ...
                  popOverCallback={(showing) => {
                    this.setColumnPopoverRootCloseBlocker(
                      "cellBackgroundColor",
                      showing
                    );
                  }}
              ...
              {column.isEditable && (
                <div>
                  ...
                  <div data-cy={`input-and-label-regex`} className="field mb-2">
                    <label className="form-label">
                      {this.props.t("widget.Table.regex", "Regex")}
                    </label>
                    <CodeHinter
                      currentState={this.props.currentState}
                      ...
                      placeholder={""}
                      onChange={(value) =>
                        this.onColumnItemChange(index, "regex", value)
                      }
                      componentName={this.getPopoverFieldSource(
                        column.columnType,
                        "regex"
                  ...
                  <div
                    data-cy={`input-and-label-min-length`}
                    className="field mb-2"
                  >
                    <label className="form-label">
                      {this.props.t("widget.Table.minLength", "Min length")}
                    </label>
                    <CodeHinter
                      currentState={this.props.currentState}
                      ...
                      placeholder={""}
                      onChange={(value) =>
                        this.onColumnItemChange(index, "minLength", value)
                      }
                      componentName={this.getPopoverFieldSource(
                        column.columnType,
                        "minLength"
                  ...
                  <div
                    data-cy={`input-and-label-max-length`}
                    className="field mb-2"
                  >
                    <label className="form-label">
                      {this.props.t("widget.Table.maxLength", "Max length")}
                    </label>
                    <CodeHinter
                      currentState={this.props.currentState}
                      ...
                      placeholder={""}
                      onChange={(value) =>
                        this.onColumnItemChange(index, "maxLength", value)
                      }
                      componentName={this.getPopoverFieldSource(
                        column.columnType,
                        "maxLength"
                  ...
                  <div
                    data-cy={`input-and-label-custom-rule`}
                    className="field mb-2"
                  >
                    <label className="form-label">
                      {this.props.t("widget.Table.customRule", "Custom rule")}
                    </label>
                    <CodeHinter
                      currentState={this.props.currentState}
                      ...
                      placeholder={""}
                      onChange={(value) =>
                        this.onColumnItemChange(index, "customRule", value)
                      }
                      componentName={this.getPopoverFieldSource(
                        column.columnType,
                        "customRule"
          ...
          {column.columnType === "number" && column.isEditable && (
            <div>
              ...
              <div data-cy={`input-and-label-min-value`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.minValue", "Min value")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
                  initialValue={column.minLength}
              ...
              <div data-cy={`input-and-label-max-value`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.maxValue", "Max value")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
                  initialValue={column.maxLength}
          ...
          {(column.columnType === "dropdown" ||
            ...
            <div>
              <div data-cy={`input-and-label-values`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.values", "Values")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
                  ...
                  placeholder={"{{[1, 2, 3]}}"}
                  onChange={(value) =>
                    this.onColumnItemChange(index, "values", value)
                  }
                  componentName={this.getPopoverFieldSource(
                    column.columnType,
                    "values"
              ...
              <div data-cy={`input-and-label-labels`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.labels", "Labels")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
                  ...
                  onChange={(value) =>
                    this.onColumnItemChange(index, "labels", value)
                  }
                  componentName={this.getPopoverFieldSource(
                    column.columnType,
                    "labels"
          ...
          {column.columnType === "datepicker" && (
            <div>
              <label
                data-cy={`label-date-display-format`}
                className="form-label"
              >
                {this.props.t(
                  "widget.Table.dateDisplayformat",
                  "Date Display Format"
                )}
              </label>
                  ...
                  <input
                    ...
                    onClick={() => {
                      this.onColumnItemChange(
                        index,
                        "isTimeChecked",
                        !column.isTimeChecked
                      );
                    }}
                    checked={column.isTimeChecked}
                  />
                  <span
                    data-cy={`label-show-time`}
          ...
          {column.columnType === "image" && (
            <>
              <div
                data-cy={`input-and-label-border-radius`}
                className="field mb-2"
              >
                <label className="form-label">
                  {this.props.t("widget.Table.borderRadius", "Border radius")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
              ...
              <div data-cy={`input-and-label-width`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.width", "Width")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
              ...
              <div data-cy={`input-and-label-height`} className="field mb-2">
                <label className="form-label">
                  {this.props.t("widget.Table.height", "Height")}
                </label>
                <CodeHinter
                  currentState={this.props.currentState}
              ...
              <div
                data-cy={`input-and-label-object-fit`}
                className="field mb-2"
              >
                <label className="form-label">
                  {this.props.t("widget.Table.objectFit", "Object fit")}
                </label>
                <SelectSearch
                  className={`${
                    this.props.darkMode ? "select-search-dark" : "select-search"
        ...
        <Popover.Content>
          <div className="field mb-2">
            ...
            <input
              ...
              onChange={(e) => {
                e.stopPropagation();
                this.onActionButtonPropertyChanged(
                  index,
                  "buttonText",
                  e.target.value
                );
          ...
          <div
            className="field mb-2"
            data-cy={`dropdown-action-button-position`}
          >
            <label
              data-cy={`label-action-button-position`}
              className="form-label"
            >
          ...
          <EventManager
            ...
            components={this.props.components}
            eventsChanged={(events) =>
              this.actionButtonEventsChanged(events, index)
            }
            apps={this.props.apps}
            popOverCallback={(showing) => {
      ...
      >
        <div
          className={`card p-2 mb-1 ${
            this.props.darkMode ? "bg-secondary" : "bg-light"
          }`}
          role="button"
        >
  ...
  removeColumn = (index) => {
    ...
    const existingcolumnDeletionHistory =
      this.props.component.component.definition.properties.columnDeletionHistory
        ?.value ?? [];
  ...
  getPopoverFieldSource = (column, field) =>
    `widget/${this.props.component.component.name}/${
      column ?? "default"
    }::${field}`;
  ...
  render() {
    ...
    const displayServerSideFilter = component.component.definition.properties
      ...
      : false;
    const displayServerSideSearch = component.component.definition.properties
      ...
      : false;
    const serverSidePagination = component.component.definition.properties
      ...
      : false;
    const clientSidePagination = component.component.definition.properties
      ...
      : false;
    const enabledSort = component.component.definition.properties.enabledSort
      ?.value
      ? resolveReferences(
                  ...
                  {columns.value.map((item, index) => {
                    return (
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            className={`card p-2 column-sort-row mb-1 ${
                              this.props.darkMode ? "" : "bg-light"
                            }`}
                            key={index}
                          ...
                          >
                            <OverlayTrigger
                              ...
                              placement="left"
                              rootClose={
                                this.state.popOverRootCloseBlockers.length === 0
                              }
        ...
        <div className="field mb-2 mt-2">
          ...
          {actions.value.length === 0 && (
            <div className="text-center">
              <small
                data-cy="message-no-action-button"
                className="color-disabled"
              >
                {this.props.t(
                  "widget.Table.noActionMessage",
...
export const ThreeColumn = withTranslation()(ThreeColumnComponent);
