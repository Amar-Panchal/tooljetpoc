...
export const MediaLogos = function MediaLogos({
  component,
  height,
  properties,
  styles,
  ...
  console.log("ddsad", component);
  const { source, loadingState, alternativeText, zoomButtons, rotateButton } =
    properties;
  const {
    visibility,
    disabledState,
  ...
  const rotateImage = () =>
    setRotation((prevValue) => (prevValue === 270 ? 0 : prevValue + 90));
  ...
  console.log("component in box", component);
  return (
    <div
