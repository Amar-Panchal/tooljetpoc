...
export const widgets = [
  ...
  },
  {
    ...
    definition: {
      ...
      properties: {
        ...
        startTime: {
          value:
            "{{moment().startOf('day').format('MM-DD-YYYY HH:mm:ss A Z')}}",
        },
        endTime: {
  ...
  },
  {
    ...
    definition: {
      ...
      properties: {
        columns: {
          value:
            '{{[{ "id": "1", "title": "to do" },{ "id": "2", "title": "in progress" }]}}',
        },
        cardData: {
          value:
  ...
  },
  {
    ...
    description: "Display an MediaLogo",
    defaultSize: {
      width: 3,
      height: 100,
    },
    ...
    definition: {
      ...
      properties: {
        source: {
          value:
            "https://elabnextstorage.blob.core.windows.net/test/8061-removebg-preview_Default_651929346.png",
        },
        visible: { value: "{{true}}" },
        loadingState: { value: "{{false}}" },
        alternativeText: { value: "" },
