        ...
        <form noValidate>
          <div className="form-group mb-3">
            <label className="form-label" data-cy="host-name-label">
              {t(
                "header.organization.menus.manageSSO.github.hostName",
                "Host Name"
              )}
            </label>
            <div>
              <input
                ...
                placeholder={t(
                  "header.organization.menus.manageSSO.github.enterHostName",
                  "Enter Host Name"
                )}
                value={hostName}
          ...
          <div className="form-group mb-3">
            <label className="form-label" data-cy="client-id-label">
              {t(
                "header.organization.menus.manageSSO.github.clientId",
                " Client Id"
              )}
            </label>
            <div>
              <input
                ...
                className="form-control"
                placeholder={t(
                  "header.organization.menus.manageSSO.github.enterClientId",
                  "Enter Client Id"
                )}
                value={clientId}
          ...
          <div className="form-group mb-3">
            <label className="form-label" data-cy="client-secret-label">
              {t(
                "header.organization.menus.manageSSO.github.clientSecret",
                "Client Secret"
              )}
              <small className="text-green mx-2" data-cy="encripted-label">
                ...
                />
                {t(
                  "header.organization.menus.manageSSO.github.encrypted",
                  "Encrypted"
                )}
              </small>
            </label>
          ...
          {configId && (
            <div className="form-group mb-3">
              <label className="form-label" data-cy="redirect-url-label">
                {t(
                  "header.organization.menus.manageSSO.github.redirectUrl",
                  "Redirect URL"
                )}
              </label>
