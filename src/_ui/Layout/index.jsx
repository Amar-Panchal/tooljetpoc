    ...
    <div className="row m-auto">
      <div className="col-auto p-0">
        <aside
          ...
          style={{
            width: 48,
            borderRight: !darkMode ? "1px solid #eee" : "inherit",
          }}
        >
                  ...
                  <ToolTip message="Dashboard" placement="right">
                    ...
                    >
                      <rect
                        ...
                        height="32"
                        rx="4"
                        fill={router.pathname === "/" ? "#E6EDFE" : "none"}
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                  ...
                  <ToolTip message="Database" placement="right">
                    ...
                    >
                      <rect
                        ...
                        rx="4"
                        fill={
                          router.pathname === "/database" ? "#E6EDFE" : "#none"
                        }
                      />
                      <path
                        fillRule="evenodd"
                  ...
                  <ToolTip message="Workspace settings" placement="right">
                    ...
                    >
                      <rect
                        ...
                        rx="4"
                        fill={
                          router.pathname === "/workspace-settings"
                            ? "#E6EDFE"
                            : "#none"
                        }
                      />
