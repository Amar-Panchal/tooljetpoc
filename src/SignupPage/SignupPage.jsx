              ...
              <form action="." method="get" autoComplete="off">
                {!signupSuccess && (
                  <div className="common-auth-container-wrapper common-auth-signup-container-wrapper">
                    ...
                    >
                      {this.props.t(
                        "loginSignupPage.joinTooljet",
                        `Join ToolJet`
                      )}
                    </h2>
                    <div
                      className="signup-page-signin-redirect"
                      data-cy="signin-redirect-text"
                    >
                      {this.props.t(
                        "loginSignupPage.alreadyHaveAnAccount",
                    ...
                    {((!this.state.configs?.enable_sign_up &&
                      ...
                      <SignupStatusCard
                        text={
                          "Signup has been disabled by your workspace admin."
                        }
                      />
                    )}
                        ...
                        {(this.state.configs?.git?.enabled ||
                          ...
                          this.isFormSignUpEnabled() && (
                            <div className="separator-signup">
                              ...
                              >
                                <h2>
                                  <span data-cy="onboarding-separator-text">
                                    OR
                                  </span>
                                </h2>
                              </div>
                        ...
                        <div className="signup-page-inputs-wrapper">
                          ...
                          <div className="signup-password-wrap">
                            ...
                            <input
                              ...
                              className="tj-text-input"
                              placeholder={this.props.t(
                                "loginSignupPage.enterWorkEmail",
                                "Enter your email"
                              )}
                            ...
                            {this.state.emailError && (
                              <span className="tj-text-input-error-state">
                                {this.state.emailError}
                              </span>
                            )}
                          </div>
                          ...
                          >
                            {isLoading ? (
                              ...
                              <>
                                <span>
                                  {this.props.t(
                                    "loginSignupPage.getStartedForFree",
