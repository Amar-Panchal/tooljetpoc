        ...
        <div className="card-header">
          ...
          {!loading && commentNotifications?.length > 0 && (
            <span
              ...
              className="text-decoration-none cursor-pointer ms-auto"
            >
        ...
        <div className="list-group list-group-flush list-group-hoverable p-3">
          ...
          {!loading && commentNotifications.length === 0 && (
            <div className="empty">
              ...
              <p
                className="empty-title mb-1"
                data-cy="empty-notification-title"
              >
                {t(
                  "header.notificationCenter.youAreCaughtUp",
                  `You're all caught up!`
                )}
              </p>
              <p
                className="empty-subtitle text-muted"
                data-cy="empty-notification-subtitle"
              >
                {`${t(
                  "header.notificationCenter.youDontHaveany",
                  `You don't have any`
                )} ${!isRead ? t("header.notificationCenter.un", "un") : ""}${t(
    ...
    >
      <div className="notification-center-nav-item cursor-pointer">
        ...
        {commentNotifications?.length !== 0 && (
          <span className="notification-center-badge badge bg-red" />
        )}
      </div>
    </OverlayTrigger>
  );
