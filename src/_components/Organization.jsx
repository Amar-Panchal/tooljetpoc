...
export const Organization = function Organization({ darkMode }) {
  ...
  const duplicateOrganizationCheck = () =>
    organizationList.some((org) => org.name === newOrgName.trim());
      ...
      <div className="organization-switchlist">
        <div className="dd-item-padding">
          <div className="d-flex">
            <div
              className="back-ico"
              onClick={() => setIsListOrganizations(false)}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="text-center">
              <a
                ...
                className={`btn btn-primary mb-2 ${
                  getOrgStatus === "loading" ? "btn-loading" : ""
                }`}
              >
                {t(
                  "header.organization.loadOrganizations",
                  "Load Organizations"
                )}
              </a>
            </div>
      ...
      <div>
        <div className="dropdown-item org-avatar">
          <div className="row">
            ...
            <div className={`col-${isSingleOrganization ? "9" : "7"}`}>
              <div
                className="org-name"
                style={{ padding: `${admin ? "0px" : "0.6rem"} 0px` }}
              >
                {organization}
              </div>
              {admin && (
            ...
            {!isSingleOrganization && (
              <div className="col-2">
                <div
                  ...
                  onClick={() => setIsListOrganizations(true)}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        {admin && (
          <>
            ...
            >
              {t(
                "header.organization.menus.menusList.manageUsers",
                "Manage Users"
              )}
            </Link>
            <Link
              data-tesid="settingsBtn"
              to="/groups"
              className="dropdown-item"
              data-cy="manage-groups"
            >
              {t(
                "header.organization.menus.menusList.manageGroups",
                "Manage Groups"
              )}
            </Link>
            <Link
        ...
        <Link
          data-tesid="settingsBtn"
          to="/manage-environment-vars"
          className="dropdown-item"
        >
          {admin
            ? t(
                "header.organization.menus.menusList.manageEnv",
  ...
  return (
    <div>
      <div
        className="dropdown organization-list"
        data-cy="dropdown-organization-list"
      >
        <a
          href="#"
          className={`btn ${
            !isSingleOrganization || admin ? "dropdown-toggle" : ""
          } ${darkMode && "text-muted"}`}
        ...
        <div className="row">
          <div className="col modal-main">
            <input
              ...
              placeholder={t(
                "header.organization.workspaceName",
                "workspace name"
              )}
              disabled={isCreating}
              maxLength={25}
