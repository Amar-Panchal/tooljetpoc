...
class ManageOrgUsersComponent extends React.Component {
  ...
  createUser = (event) => {
    ...
    if (this.handleValidation()) {
      if (
        !this.state.fields.firstName?.trim() ||
        !this.state.fields.lastName?.trim()
      ) {
                ...
                <div className="row align-items-center">
                  <div className="col">
                    ...
                    <h2 className="page-title" data-cy="users-page-title">
                      {this.props.t(
                        "header.organization.menus.manageUsers.usersAndPermission",
                        "Users & Permissions"
                      )}
                    </h2>
                  </div>
                  <div className="col-auto ms-auto d-print-none">
                    ...
                    {!showNewUserForm && !showUploadUserForm && (
                      ...
                      >
                        {this.props.t(
                          "header.organization.menus.manageUsers.inviteNewUser",
                          "Invite new user"
                        )}
                      </div>
                    )}
                    ...
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title" data-cy="add-new-user">
                          {this.props.t(
                            "header.organization.menus.manageUsers.addNewUser",
                            "Add new user"
                          )}
                        </h3>
                      </div>
                            ...
                            <div className="row">
                              <div className="col">
                                <input
                                  ...
                                  name="firstName"
                                  onChange={this.changeNewUserOption.bind(
                                    this,
                                    "firstName"
                                  )}
                          ...
                          <div className="form-footer">
                            ...
                            <button
                              ...
                              className={`btn mx-2 btn-primary ${
                                creatingUser ? "btn-loading" : ""
                              }`}
                              disabled={creatingUser}
                              data-cy="create-user-button"
                            >
                              {this.props.t(
                                "header.organization.menus.manageUsers.createUser",
                                "Create User"
                              )}
                            </button>
                          </div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <h3
                          ...
                          data-cy="bulk-user-upload-page-title"
                        >
                          Upload Users
                        </h3>
                      </div>
                                ...
                                <input
                                  onChange={(e) => {
                                    ...
                                    if (Math.round(file.size / 1024) > 1024) {
                                      toast.error(
                                        "File size cannot exceed more than 1MB"
                                      );
                                      e.target.value = null;
                                    } else {
                ...
                {users?.length === 0 &&
                  ...
                  !showUploadUserForm && (
                    <div className="d-flex justify-content-center flex-column">
                      <span className="text-center pt-5 font-weight-bold">
                        No result found
                      </span>
